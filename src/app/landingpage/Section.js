...
import FilterOption from "@/components/buttons/FilterOptions";
                    ...
                    <div className="flex justify-between items-center section-main-content section-first-links-box">
                        ...
                        <div className="filternames-container">
                            ...
                            <div className={rightFiltersShow ? "right-side-remaining-filter-container filter-height-visible" : "right-side-remaining-filter-container"}>
                                <FilterOption label="RECOMMENDED" value="RECOMMENDED" selectedValue={rightFiltersSelectedValue} onSelect={setRightFiltersSelectedValue} />
                                <FilterOption label="Newest first" value="Newest first" selectedValue={rightFiltersSelectedValue} onSelect={setRightFiltersSelectedValue} />
                                <FilterOption label="Popular" value="Popular" selectedValue={rightFiltersSelectedValue} onSelect={setRightFiltersSelectedValue} />
                                <FilterOption label="Price : high to low" value="Price : high to low" selectedValue={rightFiltersSelectedValue} onSelect={setRightFiltersSelectedValue} />
                                <FilterOption label="Price : low to high" value="Price : low to high" selectedValue={rightFiltersSelectedValue} onSelect={setRightFiltersSelectedValue} />
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="flex section-main-content section-left-filter-products-parent-container">
                        ...
                        <div className="products-container">
                            ...
                            {apiData.length > 0 && apiData.map((element, index) => {
                                return <ProductCard id={element?.id} key={index} Img={element.image} catagory={element.category} count={element.rating.count} price={element.price} rating={element.rating.rate} title={element.title} />;
                            })}
                        </div>
                    </div>
                </section>
