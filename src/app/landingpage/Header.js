...
//components
import HeaderLinks from '@/components/buttons/HeaderLinks';
            ...
            <header>
                ...
                <div className="">
                    <div className={navbarshow ? "flex navbar-link-container show" : "flex navbar-link-container"}>
                        ...
                        <HeaderLinks content={'SHOP'}/>
                        <HeaderLinks content={'SKILLS'}/>
                        <HeaderLinks content={'STORIES'}/>
                        <HeaderLinks content={'ABOUT'}/>
                        <HeaderLinks content={'CONTACT US'}/>
                    </div>
                </div>
